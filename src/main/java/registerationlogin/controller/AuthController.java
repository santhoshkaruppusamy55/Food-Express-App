...
public class AuthController {
    ...
    // model.addAttribute("user", userDto); // model object is used to store data
    // that is entered from form.
    // return "register";
    // }
    ...
    public String registration(@Valid @ModelAttribute("user") UserDto userDto, BindingResult result, Model model) { // Model
                                                                                                                    // attribute
                                                                                                                    // is
                                                                                                                    // used
                                                                                                                    // to
        ...
        User existingUser = userService.findByEmail(userDto.getEmail()); // checking if entered email already exists or
                                                                         // not.
        ...
        return "redirect:/register?success"; // @Valid from jakarta.validation will enable the validation fields of dto
                                             // objectsto be enabled.
